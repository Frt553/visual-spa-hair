...
export default function Home() {
  return <main>
    ...
    <div className="service-marquee" aria-label="Principais serviços"><div className="marquee-photo"><Image src="/media/resultados-print.jpg" alt="Galeria de resultados do salão" width={180} height={390} /></div><div className="marquee-text">Cortes <b>•</b> Mechas <b>•</b> Coloração <b>•</b> Progressiva <b>•</b> Mega hair <b>•</b> Terapia capilar <b>•</b> Make <b>•</b> Consultoria capilar <b>•</b> Escovas e penteados <b>•</b> Masculino e feminino</div></div>
