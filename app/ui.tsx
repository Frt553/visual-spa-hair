...
export function SiteHeader() {
  ...
  return <header className="site-header"><div className="header-inner wrap">
    ...
    <nav className={open ? "main-nav open" : "main-nav"} aria-label="Navegação principal">
      ...
      <a className="nav-cta" href="https://api.whatsapp.com/send?phone=5545998361763&text=Olá!%20Gostaria%20de%20agendar%20um%20horário." target="_blank" rel="noreferrer">Agendar <span>↗</span></a>
    </nav>
  </div></header>;
}
...
export function SiteFooter() {
  return <footer className="site-footer"><div className="wrap footer-grid">
    <div><Link className="brand footer-brand" href="/"><span>Visual</span><small>SPA · HAIR</small></Link><p>24 anos realçando a sua beleza.</p></div>
